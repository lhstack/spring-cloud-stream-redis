...
public class RedisStreamBinderAutoConfiguration {
    ...
    @Bean
    public RedisStreamMessageChannelBinder redisStreamBinder(RedisProvisioningProvider redisProvisioningProvider) throws IOException {
        return new RedisStreamMessageChannelBinder(redisProvisioningProvider, redisStreamClientProperties, redisExtendBindingProperties);
    }
